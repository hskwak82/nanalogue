...
const features = [
  {
    ...
    title: '대화로 기록',
    shortDesc: '편하게 대화하세요',
    description: '편안한 상대와 자연스럽게 대화하면, AI가 하루를 정리해 일기로 남깁니다.',
    details: [
      '복잡한 글쓰기 없이 대화만으로 일기 완성',
      '친구처럼 편하게, 하루 이야기를 나누세요',
      '감정, 사건, 생각을 자연스럽게 정리',
    ],
...
export function AboutContent({ isLoggedIn }: AboutContentProps) {
