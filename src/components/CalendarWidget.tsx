    ...
    <div className="space-y-4">
      ...
      {needsReconnection && onConnect && (
        <div className="rounded-xl bg-amber-50 p-4 border border-amber-200">
          ...
          <button
            onClick={onConnect}
            className="w-full flex items-center justify-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-amber-100 transition-all border border-amber-300"
          >
      ...
      {!isConnected && !needsReconnection && onConnect && (
        <div className="rounded-xl bg-pastel-warm p-4 border border-pastel-pink/30">
          ...
          <button
            onClick={onConnect}
            className="w-full flex items-center justify-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-pastel-pink-light transition-all border border-pastel-pink"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24">
              <path
                fill="#4285F4"
